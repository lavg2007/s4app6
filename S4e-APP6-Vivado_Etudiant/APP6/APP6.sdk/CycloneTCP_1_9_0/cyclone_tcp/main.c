...
{
	XIntc_Acknowledge(&InterruptController, XPAR_CALCUL_MOYENNE_AXI_INTC_0_CALCUL_MOYENNE_MYIP_0_O_DATA_AVAILABLE_INTR);
...
int SetupInterruptSystem()
{
	 ...
	 */
	Status = XIntc_Connect(&InterruptController, XPAR_CALCUL_MOYENNE_AXI_INTC_0_CALCUL_MOYENNE_MYIP_0_O_DATA_AVAILABLE_INTR,
	...
	XIntc_Enable(&InterruptController, XPAR_CALCUL_MOYENNE_AXI_INTC_0_CALCUL_MOYENNE_MYIP_0_O_DATA_AVAILABLE_INTR);

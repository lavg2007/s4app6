...
proc create_hier_cell_Calcul_Moyenne { parentCell nameHier } {
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins CLK] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins myip_0/s00_axi_aclk]
  connect_bd_net -net myip_0_o_data [get_bd_pins myip_0/i_moyenne_data] [get_bd_pins myip_0/i_somme_data] [get_bd_pins myip_0/o_data]
  connect_bd_net -net myip_0_o_data_available [get_bd_pins myip_0/o_data_available] [get_bd_pins xlconcat_0/In0]
